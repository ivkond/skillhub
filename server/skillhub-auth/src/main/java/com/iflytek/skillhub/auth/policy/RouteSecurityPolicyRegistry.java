...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<RouteAuthorizationPolicy> AUTHORIZATION_POLICIES = List.of(
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/public/collections/*/*"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/public/collections/*/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/me/collections"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/web/me/collections"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/collections/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/web/collections/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PATCH, "/api/v1/collections/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PATCH, "/api/web/collections/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/v1/collections/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/web/collections/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/collections"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/web/collections"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/collections/*/skills"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/web/collections/*/skills"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/v1/collections/*/skills/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/web/collections/*/skills/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PUT, "/api/v1/collections/*/skills/order"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PUT, "/api/web/collections/*/skills/order"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/collections/*/contributors"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/web/collections/*/contributors"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/collections/*/contributors"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/web/collections/*/contributors"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/v1/collections/*/contributors/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/web/collections/*/contributors/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PATCH, "/api/v1/collections/*/visibility"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PATCH, "/api/web/collections/*/visibility"),
    ...
    private static final List<ApiTokenPolicy> API_TOKEN_POLICIES = List.of(
            ...
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/skills/**"),
            // Collections API tokens remain read-only for public catalog in v1; write routes are intentionally unsupported.
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/public/collections/**"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/public/collections/**"),
